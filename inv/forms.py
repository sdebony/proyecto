...
class ProductoForm(forms.ModelForm):
    class Meta:
        ...
        fields=['codigo','codigo_barra','descripcion','estado', \
                ...
                'marca','subcategoria','unidad_medida','foto'] #,'codigo_envase','fecha_venc']
        exclude = ['um','fm','uc','fc']
        widget={'descripcion': forms.TextInput()}
...
class TubosForm(forms.ModelForm):
    class Meta:
        model=Tubos
        fields=['codigo','codigo_barra','descripcion','estado', \
                'marca','unidad_medida','fecha_venc']
        exclude = ['um','fm','uc','fc']
        widget={'descripcion': forms.TextInput()}
