...
urlpatterns = [
    ...
    path('tubos/',TubosView.as_view(), name="tubos_list"),
    path('tubos/edit/<int:pk>',TubosEdit.as_view(), name="tubos_edit"),
    path('tubos/new',TubosNew.as_view(), name="tubos_new"),
]